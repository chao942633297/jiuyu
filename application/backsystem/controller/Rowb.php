		...
		***/
        public function rowlist()
        {
           /* $info = RowModel::all(function($query){
            ...
            return $this->fetch('row/rowlistb');
        }
