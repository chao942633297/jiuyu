...
{
    protected $userId;
    protected $service_phone;

    public function _initialize()
    {
        parent::_initialize(); // TODO: Change the autogenerated stub
        $this->userId = session('home_user_id');
        $this->service_phone = '400-955-123';
    }
    ...
    public function actBuyCar(Request $request){
      ...
      /*  $count = db('order')->where('uid',$this->userId)->count();
        ...
        try{
            ...
            if($user['balance'] < 0){
                Db::rollback();
                return json(['msg'=>'提交购车失败','code'=>1005]);
            }else{
    ...
    public function myOrder(Request $request){
        ...
        if(!empty($carOrderData)){
            $carOrderData[0]['service_phone'] = $this->service_phone;
        }
    ...
    public function orderDetail(Request $request){
        ...
        $carOrderData = Db::table('sql_order')
            ->field('id,order_sn,buyer_name,buyer_phone,buyer_address,good_name,good_price,good_img,price,status,created_at')
            ->where('id',$orderId)
            ->order('id','desc')->select();
        if(!empty($carOrderData)){
            $carOrderData[0]['service_phone'] = $this->service_phone;
